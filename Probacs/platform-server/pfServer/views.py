...
def execute(request):
    ...
    if cl == None:
        ...
        os.system("python3 make_compilation.py " + taskFolder + " " +
                  request.POST['target_os'] + " " + request.POST['compiler'] +
                  " " + request.POST['version'] + " " + compileDir + " " +
                  request.POST['command'] + " " + request.POST['flags'] + " " +
        ...
        os.system(cl+"&& python3 make_compilation.py "+taskFolder+" "+
         ...
         compileDir+" "+request.POST['command']+" "+request.POST['flags']+" "+dest_name+" "+hostserver)
